              ...
              {archive.length > 0 ? (
                <div className="mt-14 border-t border-[#e8dece] pt-12">
                  ...
                  <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    {archive.map((post) => (
                      <Link key={post.id} href={`/ai-guides/${post.slug}`} className="group overflow-hidden rounded-[26px] border border-[#e7ddd0] bg-[#111111] shadow-[0_18px_46px_rgba(15,23,42,0.1)] transition hover:-translate-y-0.5 hover:border-[#d5b36a]">
