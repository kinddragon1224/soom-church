...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-[#080b12] text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-5 text-[3.05rem] font-black leading-[0.95] tracking-[-0.085em] sm:text-[5.5rem]">
              지금 막힌 선택을
              <br />
              하나만 가져오세요.
            </h1>
            <p className="mt-7 max-w-3xl text-base leading-8 text-white/66">
      ...
      <section>
        <div className="mx-auto grid max-w-7xl gap-8 px-5 pb-20 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:pb-28">
          <div className="rounded-[38px] border border-white/10 bg-[#0d1117] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.24)] sm:p-8">
            <ConsultationInquiryForm />
          </div>
          <div className="grid gap-5 self-start">
            <div className="rounded-[34px] border border-white/10 bg-white/[0.045] p-6 sm:p-8">
            ...
            <div className="rounded-[34px] border border-white/10 bg-[#0d1117] p-6 sm:p-8">
