...
export default async function GidoDashboardPage({
  ...
  const notificationItemsBase: Array<GidoHomePanelItem | null> = [
      ...
      : null,
    {
      ...
      body: urgentMemberCount > 0 ? "확인할 관리 대상 있음" : "새 관리 알림 없음",
      href: `${base}/followups`,
      meta: "운영 알림",
  ...
  return (
    <div className="flex flex-col gap-4 lg:gap-5">
      ...
      <section className="grid gap-4 lg:grid-cols-4">
        <ActionCard title="관리" desc="관리 대상과 카드 확인" href={`${base}/followups`} meta={`${urgentMemberCount}명`} />
        ...
        <ActionCard title="운영 우선 목원" desc="관리, 현 목자, 순환 진행 가정 목록" href={`${base}/members?filter=priority`} meta={`${urgentMemberCount}명 관리`} />
      </section>
    </div>
  );
}
