    ...
    <div className="flex flex-col gap-5 text-[#111111]">
      <section className="rounded-[28px] border border-[#e6dfd5] bg-white p-5 shadow-[0_10px_28px_rgba(15,23,42,0.05)] sm:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div>
            <p className="text-[11px] tracking-[0.18em] text-[#9a8b7a]">G.I.D.O MANAGEMENT</p>
            <h1 className="mt-2 text-[2rem] font-semibold tracking-[-0.05em] text-[#111111]">관리</h1>
            <p className="mt-2 text-sm leading-6 text-[#5f564b]">실행 대상, 관리 카드, 순환 진행 체크</p>
          </div>
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          <MetricCard label="관리 대상" value={`${counts.followup}명`} tone={counts.followup > 0 ? "alert" : "neutral"} />
      ...
      <section className="grid gap-4 xl:grid-cols-[1.02fr_0.98fr]">
        <article className="rounded-[24px] border border-[#e6dfd5] bg-white p-5 shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-[11px] tracking-[0.18em] text-[#9a8b7a]">MANAGEMENT CARDS</p>
              <h2 className="mt-2 text-lg font-semibold text-[#111111]">기록된 관리 카드</h2>
            </div>
      ...
      <section className="rounded-[24px] border border-[#e6dfd5] bg-white p-5 shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 text-lg font-semibold text-[#111111]">관리 대상 보드</h2>
          </div>
              ...
              <article key={`board-${member.id}`} className="rounded-[18px] border border-[#ece4d8] bg-[#fbfaf7] p-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex flex-wrap justify-end gap-1.5 text-[11px]">
                    ...
                    {member.requiresFollowUp ? <span className="rounded-full bg-[#fff4df] px-2.5 py-1 text-[#8C6A2E]">관리 필요</span> : null}
                  </div>
                </div>
                <p className="mt-3 text-sm leading-6 text-[#5f564b]">{member.priorityReason.body}</p>
                <div className="mt-4 flex flex-wrap gap-2">
