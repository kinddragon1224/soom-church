...
const careerFieldHints: Array<{ field: HistoryRoadmapInput["field"]; keywords: string[] }> = [
  { field: "보건의료", keywords: ["간호", "의사", "약사", "물리치료", "응급", "보건", "치위생", "치과", "수의사", "임상병리", "방사선"] },
  { field: "법정치", keywords: ["변호", "검사", "판사", "법", "정치", "외교", "행정", "공무원", "법조", "노무사", "변리사"] },
  { field: "교육", keywords: ["교사", "선생", "교육", "교수", "유아", "초등", "중등", "사범", "강사", "특수교사"] },
  { field: "공학기술", keywords: ["개발", "프로그래머", "엔지니어", "건축", "로봇", "기계", "전기", "컴퓨터", "AI", "데이터", "토목", "도시", "소프트웨어"] },
  { field: "문화예술", keywords: ["디자인", "음악", "미술", "배우", "영화", "연극", "패션", "미용", "헤어", "메이크업", "일러스트", "사진", "무용"] },
  { field: "미디어콘텐츠", keywords: ["유튜브", "PD", "기자", "방송", "콘텐츠", "마케팅", "광고", "웹툰", "프로게이머", "e스포츠", "스트리머", "크리에이터", "게임"] },
  { field: "경영경제", keywords: ["경영", "경제", "회계", "창업", "금융", "무역", "세무", "마케터", "사업가", "기획자", "유통", "승무원", "관광", "여행", "호텔", "요리", "셰프", "조리"] },
  { field: "군사안보", keywords: ["군인", "경찰", "소방", "안보", "장교", "부사관", "경호", "군무원", "운동선수", "체육", "스포츠", "트레이너", "코치"] },
  { field: "복지상담", keywords: ["상담", "심리", "사회복지", "복지", "청소년", "직업상담", "재활", "보육", "목사", "전도사", "신학", "교회", "선교", "사역", "종교"] },
  { field: "자연과학", keywords: ["생명", "화학", "물리", "지구", "수학", "연구원", "과학자", "천문", "환경", "기상", "농업", "식품공학"] },
