...
- 고객 축:
  - 3040: 방향 전환, 일, 관계, 생산성, AI 활용
  - 5060: 삶 정리, 신앙적 해석, 후반전 브랜딩, 자기 언어 만들기
...
- 01:10: 다음 날 이미지 프롬프트 3개 생성 (오후 슬롯용 15/19/21시)
- 07:00~23:00: 슬롯별 자동 게시
- 오후 슬롯 이미지는 사용자가 오전에 직접 생성 후 전달하는 반수동 구조 가능
