export const STATUS_FLOW = {
  등록대기: {
    ...
    quickActions: ["기본 정보 수정", "교구 배정", "목장 배정"],
  },
  새가족: {
    label: "새가족",
    stage: "첫 연결",
    ...
    quickActions: ["첫 연락 기록", "가족 연결", "다음 단계 지정"],
  },
  정착중: {
    label: "정착중",
    stage: "정착 지원",
    ...
    quickActions: ["정착 메모", "출석 확인", "목장 참여 확인"],
  },
  목장배정완료: {
    label: "목장배정완료",
    stage: "배정 완료",
    ...
    quickActions: ["목장 정보 확인", "리더 연결", "정착중 전환"],
  },
  봉사연결: {
    label: "봉사연결",
    stage: "사역 연결",
    ...
    quickActions: ["사역 배정 확인", "봉사 기록", "참여 상태 확인"],
  },
  휴면: {
    label: "휴면",
    stage: "재접촉 필요",
    ...
    quickActions: ["재연락 시도", "심방 검토", "상태 재평가"],
  },
  심방필요: {
    label: "심방필요",
    stage: "집중 돌봄",
    ...
    quickActions: ["심방 기록", "가정 메모", "후속 일정 확인"],
  },
} as const;
